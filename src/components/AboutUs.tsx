...
const AboutUs = () => {
  ...
  <section className="flex flex-row items-center gap-10 px-6 py-16 max-w-6xl mx-auto">
    ...
    <button className="px-5 py-2.5 text-xl mt-6 bg-red-400 text-white rounded-2xl hover:bg-red-500">See More</button>
    </div>
  ...
  <section className=" flex md:flex-row-reverse items-center gap-10 px-6 py-16 max-w-6xl mx-auto">
    <div className="md:w-1/2 text-center md:text-left">
      ...
      <button className="px-5 py-2.5 text-2xl text-white bg-red-400 rounded-2xl hover:bg-red-500">See more
      </button>
    </div>
